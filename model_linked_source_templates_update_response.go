...
// checks if the LinkedSourceTemplatesUpdateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkedSourceTemplatesUpdateResponse{}

// LinkedSourceTemplatesUpdateResponse linked source template details based on the ot-collector tags user wants to update.
type LinkedSourceTemplatesUpdateResponse struct {
	// otCollector id for which tags are edited.
	CollectorId string `json:"collectorId"`
	// list of sourceTemplates which are linked to otCollector.
...
func NewLinkedSourceTemplatesUpdateResponse(collectorId string) *LinkedSourceTemplatesUpdateResponse {
	this := LinkedSourceTemplatesUpdateResponse{}
...
// GetAddedSourceTemplates returns the AddedSourceTemplates field value if set, zero value otherwise.
func (o *LinkedSourceTemplatesUpdateResponse) GetAddedSourceTemplates() []LinkingUpdatedSourceTemplateDetails {
	if o == nil || IsNil(o.AddedSourceTemplates) {
		var ret []LinkingUpdatedSourceTemplateDetails
		return ret
	}
	return o.AddedSourceTemplates
}

// GetAddedSourceTemplatesOk returns a tuple with the AddedSourceTemplates field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LinkedSourceTemplatesUpdateResponse) GetAddedSourceTemplatesOk() ([]LinkingUpdatedSourceTemplateDetails, bool) {
	if o == nil || IsNil(o.AddedSourceTemplates) {
		return nil, false
	}
	return o.AddedSourceTemplates, true
}
...
// SetAddedSourceTemplates gets a reference to the given []LinkingUpdatedSourceTemplateDetails and assigns it to the AddedSourceTemplates field.
func (o *LinkedSourceTemplatesUpdateResponse) SetAddedSourceTemplates(v []LinkingUpdatedSourceTemplateDetails) {
	o.AddedSourceTemplates = v
}

// GetRemovedSourceTemplates returns the RemovedSourceTemplates field value if set, zero value otherwise.
func (o *LinkedSourceTemplatesUpdateResponse) GetRemovedSourceTemplates() []LinkingUpdatedSourceTemplateDetails {
	if o == nil || IsNil(o.RemovedSourceTemplates) {
		var ret []LinkingUpdatedSourceTemplateDetails
		return ret
	}
	return o.RemovedSourceTemplates
}

// GetRemovedSourceTemplatesOk returns a tuple with the RemovedSourceTemplates field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LinkedSourceTemplatesUpdateResponse) GetRemovedSourceTemplatesOk() ([]LinkingUpdatedSourceTemplateDetails, bool) {
	if o == nil || IsNil(o.RemovedSourceTemplates) {
		return nil, false
	}
	return o.RemovedSourceTemplates, true
}
...
// SetRemovedSourceTemplates gets a reference to the given []LinkingUpdatedSourceTemplateDetails and assigns it to the RemovedSourceTemplates field.
func (o *LinkedSourceTemplatesUpdateResponse) SetRemovedSourceTemplates(v []LinkingUpdatedSourceTemplateDetails) {
	o.RemovedSourceTemplates = v
}

func (o LinkedSourceTemplatesUpdateResponse) MarshalJSON() ([]byte, error) {
...
func (o LinkedSourceTemplatesUpdateResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["collectorId"] = o.CollectorId
	if !IsNil(o.AddedSourceTemplates) {
		toSerialize["addedSourceTemplates"] = o.AddedSourceTemplates
	}
...
func (o *LinkedSourceTemplatesUpdateResponse) UnmarshalJSON(data []byte) (err error) {
...
type NullableLinkedSourceTemplatesUpdateResponse struct {
	value *LinkedSourceTemplatesUpdateResponse
	isSet bool
}

func (v NullableLinkedSourceTemplatesUpdateResponse) Get() *LinkedSourceTemplatesUpdateResponse {
	return v.value
}

func (v *NullableLinkedSourceTemplatesUpdateResponse) Set(val *LinkedSourceTemplatesUpdateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkedSourceTemplatesUpdateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkedSourceTemplatesUpdateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkedSourceTemplatesUpdateResponse(val *LinkedSourceTemplatesUpdateResponse) *NullableLinkedSourceTemplatesUpdateResponse {
	return &NullableLinkedSourceTemplatesUpdateResponse{value: val, isSet: true}
}

func (v NullableLinkedSourceTemplatesUpdateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkedSourceTemplatesUpdateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
