...
// checks if the SCIMCreateUserDefinitionRolesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SCIMCreateUserDefinitionRolesInner{}

// SCIMCreateUserDefinitionRolesInner struct for SCIMCreateUserDefinitionRolesInner
type SCIMCreateUserDefinitionRolesInner struct {
...
func NewSCIMCreateUserDefinitionRolesInner() *SCIMCreateUserDefinitionRolesInner {
	this := SCIMCreateUserDefinitionRolesInner{}
...
func (o SCIMCreateUserDefinitionRolesInner) MarshalJSON() ([]byte, error) {
...
func (o SCIMCreateUserDefinitionRolesInner) ToMap() (map[string]interface{}, error) {
...
type NullableSCIMCreateUserDefinitionRolesInner struct {
	value *SCIMCreateUserDefinitionRolesInner
	isSet bool
}

func (v NullableSCIMCreateUserDefinitionRolesInner) Get() *SCIMCreateUserDefinitionRolesInner {
	return v.value
}

func (v *NullableSCIMCreateUserDefinitionRolesInner) Set(val *SCIMCreateUserDefinitionRolesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSCIMCreateUserDefinitionRolesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSCIMCreateUserDefinitionRolesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSCIMCreateUserDefinitionRolesInner(val *SCIMCreateUserDefinitionRolesInner) *NullableSCIMCreateUserDefinitionRolesInner {
	return &NullableSCIMCreateUserDefinitionRolesInner{value: val, isSet: true}
}

func (v NullableSCIMCreateUserDefinitionRolesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSCIMCreateUserDefinitionRolesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
