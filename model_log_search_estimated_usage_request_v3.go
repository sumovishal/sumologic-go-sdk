...
// GetEmulateSearchContext returns the EmulateSearchContext field value if set, zero value otherwise.
func (o *LogSearchEstimatedUsageRequestV3) GetEmulateSearchContext() LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext {
	if o == nil || IsNil(o.EmulateSearchContext) {
		var ret LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext
		return ret
	}
	return *o.EmulateSearchContext
}

// GetEmulateSearchContextOk returns a tuple with the EmulateSearchContext field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LogSearchEstimatedUsageRequestV3) GetEmulateSearchContextOk() (*LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext, bool) {
	...
	return o.EmulateSearchContext, true
}
...
// SetEmulateSearchContext gets a reference to the given LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext and assigns it to the EmulateSearchContext field.
...
func (o LogSearchEstimatedUsageRequestV3) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EmulateSearchContext) {
...
func (o *LogSearchEstimatedUsageRequestV3) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varLogSearchEstimatedUsageRequestV3)
