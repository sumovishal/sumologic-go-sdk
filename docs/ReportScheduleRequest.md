...
`func NewReportScheduleRequest(dashboardId string, reportFormat string, scheduleType string, timeZone string, emailNotification Email, ) *ReportScheduleRequest`
