...
**EmailNotification** | [**Email**](Email.md) |  | 
...
`func NewReportSchedule(dashboardId string, reportFormat string, scheduleType string, timeZone string, emailNotification Email, ) *ReportSchedule`
