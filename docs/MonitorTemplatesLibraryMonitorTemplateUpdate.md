...
`func NewMonitorTemplatesLibraryMonitorTemplateUpdate(monitorType string, queries []MonitorQuery, triggers []TriggerCondition, ) *MonitorTemplatesLibraryMonitorTemplateUpdate`
