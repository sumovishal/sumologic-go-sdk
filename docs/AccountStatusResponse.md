...
**LogModel** | Pointer to **string** | The log model of the account | [optional] 
...
GetLogModel returns the LogModel field if non-nil, zero value otherwise.

### GetLogModelOk

`func (o *AccountStatusResponse) GetLogModelOk() (*string, bool)`

GetLogModelOk returns a tuple with the LogModel field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetLogModel sets LogModel field to given value.
