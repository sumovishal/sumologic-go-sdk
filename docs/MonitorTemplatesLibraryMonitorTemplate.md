...
`func NewMonitorTemplatesLibraryMonitorTemplate(monitorType string, appId string, queries []MonitorQuery, triggers []TriggerCondition, ) *MonitorTemplatesLibraryMonitorTemplate`
