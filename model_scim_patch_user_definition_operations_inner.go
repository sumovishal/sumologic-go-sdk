...
// checks if the SCIMPatchUserDefinitionOperationsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SCIMPatchUserDefinitionOperationsInner{}

// SCIMPatchUserDefinitionOperationsInner struct for SCIMPatchUserDefinitionOperationsInner
type SCIMPatchUserDefinitionOperationsInner struct {
	// We will only support `replace` operation.
	Op *string `json:"op,omitempty" validate:"regexp=^(replace|add|remove)$"`
...
func NewSCIMPatchUserDefinitionOperationsInner() *SCIMPatchUserDefinitionOperationsInner {
	this := SCIMPatchUserDefinitionOperationsInner{}
	return &this
}
...
func (o *SCIMPatchUserDefinitionOperationsInner) GetValue() SCIMPatchUserDefinitionOperationsInnerValue {
	if o == nil || IsNil(o.Value) {
		var ret SCIMPatchUserDefinitionOperationsInnerValue
		return ret
	}
	return *o.Value
}
...
// SetValue gets a reference to the given SCIMPatchUserDefinitionOperationsInnerValue and assigns it to the Value field.
func (o *SCIMPatchUserDefinitionOperationsInner) SetValue(v SCIMPatchUserDefinitionOperationsInnerValue) {
	o.Value = &v
}

func (o SCIMPatchUserDefinitionOperationsInner) MarshalJSON() ([]byte, error) {
...
func (o SCIMPatchUserDefinitionOperationsInner) ToMap() (map[string]interface{}, error) {
...
type NullableSCIMPatchUserDefinitionOperationsInner struct {
	value *SCIMPatchUserDefinitionOperationsInner
	isSet bool
}

func (v NullableSCIMPatchUserDefinitionOperationsInner) Get() *SCIMPatchUserDefinitionOperationsInner {
	return v.value
}

func (v *NullableSCIMPatchUserDefinitionOperationsInner) Set(val *SCIMPatchUserDefinitionOperationsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSCIMPatchUserDefinitionOperationsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSCIMPatchUserDefinitionOperationsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSCIMPatchUserDefinitionOperationsInner(val *SCIMPatchUserDefinitionOperationsInner) *NullableSCIMPatchUserDefinitionOperationsInner {
	return &NullableSCIMPatchUserDefinitionOperationsInner{value: val, isSet: true}
}

func (v NullableSCIMPatchUserDefinitionOperationsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSCIMPatchUserDefinitionOperationsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
