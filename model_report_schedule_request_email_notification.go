...
var _ MappedNullable = &ReportScheduleRequestEmailNotification{}

// ReportScheduleRequestEmailNotification The email the dashboard report will be sent at the scheduled data and time.
type ReportScheduleRequestEmailNotification struct {
	Email
...
func NewReportScheduleRequestEmailNotification(connectionType string, recipients []string, subject string) *ReportScheduleRequestEmailNotification {
	this := ReportScheduleRequestEmailNotification{}
...
func (o ReportScheduleRequestEmailNotification) MarshalJSON() ([]byte, error) {
...
func (o ReportScheduleRequestEmailNotification) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	serializedEmail, errEmail := json.Marshal(o.Email)
	if errEmail != nil {
		return map[string]interface{}{}, errEmail
	}
	errEmail = json.Unmarshal([]byte(serializedEmail), &toSerialize)
	if errEmail != nil {
		return map[string]interface{}{}, errEmail
	}
	if !IsNil(o.TimeZone) {
...
func (o *ReportScheduleRequestEmailNotification) UnmarshalJSON(data []byte) (err error) {
...
type NullableReportScheduleRequestEmailNotification struct {
	value *ReportScheduleRequestEmailNotification
	isSet bool
}

func (v NullableReportScheduleRequestEmailNotification) Get() *ReportScheduleRequestEmailNotification {
	return v.value
}

func (v *NullableReportScheduleRequestEmailNotification) Set(val *ReportScheduleRequestEmailNotification) {
	v.value = val
	v.isSet = true
}

func (v NullableReportScheduleRequestEmailNotification) IsSet() bool {
	return v.isSet
}

func (v *NullableReportScheduleRequestEmailNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportScheduleRequestEmailNotification(val *ReportScheduleRequestEmailNotification) *NullableReportScheduleRequestEmailNotification {
	return &NullableReportScheduleRequestEmailNotification{value: val, isSet: true}
}

func (v NullableReportScheduleRequestEmailNotification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportScheduleRequestEmailNotification) UnmarshalJSON(src []byte) error {
	v.isSet = true
