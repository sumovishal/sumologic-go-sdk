...
func (o *DoubleTracingValue) UnmarshalJSON(data []byte) (err error) {
	...
	type DoubleTracingValueWithoutEmbeddedStruct struct {
		Value float64 `json:"value"`
	}

	varDoubleTracingValueWithoutEmbeddedStruct := DoubleTracingValueWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varDoubleTracingValueWithoutEmbeddedStruct)
	if err == nil {
		varDoubleTracingValue := _DoubleTracingValue{}
		varDoubleTracingValue.Value = varDoubleTracingValueWithoutEmbeddedStruct.Value
	...
	err = json.Unmarshal(data, &varDoubleTracingValue)
	if err == nil {
		o.TracingValue = varDoubleTracingValue.TracingValue
	} else {
		return err
	}
