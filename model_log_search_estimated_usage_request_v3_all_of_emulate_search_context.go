...
// checks if the LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext{}

// LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext Contains keys like \"roleIds\" with a list of role IDs or \"userId\" as a string. 
...
func NewLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext() *LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext {
	this := LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext{}
	return &this
}
...
func (o LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext) MarshalJSON() ([]byte, error) {
...
func (o LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext) ToMap() (map[string]interface{}, error) {
...
type NullableLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext struct {
	value *LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext
	isSet bool
}

func (v NullableLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext) Get() *LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext {
	return v.value
}

func (v *NullableLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext) Set(val *LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext) {
	v.value = val
	v.isSet = true
}

func (v NullableLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext) IsSet() bool {
	return v.isSet
}

func (v *NullableLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext(val *LogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext) *NullableLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext {
	return &NullableLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext{value: val, isSet: true}
}

func (v NullableLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogSearchEstimatedUsageRequestV3AllOfEmulateSearchContext) UnmarshalJSON(src []byte) error {
	v.isSet = true
