...
type ApiDeleteParentOrgSamlConfigRequest struct {
	ctx context.Context
	ApiService *SamlConfigurationManagementAPIService
}

func (r ApiDeleteParentOrgSamlConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteParentOrgSamlConfigExecute(r)
}

/*
DeleteParentOrgSamlConfig Delete parent org SAML configuration

Deletes the SAML configuration setup for enabling login via parent org.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiDeleteParentOrgSamlConfigRequest
*/
func (a *SamlConfigurationManagementAPIService) DeleteParentOrgSamlConfig(ctx context.Context) ApiDeleteParentOrgSamlConfigRequest {
	return ApiDeleteParentOrgSamlConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *SamlConfigurationManagementAPIService) DeleteParentOrgSamlConfigExecute(r ApiDeleteParentOrgSamlConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SamlConfigurationManagementAPIService.DeleteParentOrgSamlConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/saml/identityProviders/parentOrgConfig"
