...
// checks if the OutlierSeriesDataPointAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OutlierSeriesDataPointAllOf{}
...
func (o OutlierSeriesDataPointAllOf) ToMap() (map[string]interface{}, error) {
