...
// checks if the SpanQueryFieldDetailAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpanQueryFieldDetailAllOf{}
...
func (o SpanQueryFieldDetailAllOf) ToMap() (map[string]interface{}, error) {
