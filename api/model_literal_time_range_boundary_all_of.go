...
// checks if the LiteralTimeRangeBoundaryAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LiteralTimeRangeBoundaryAllOf{}
...
func (o LiteralTimeRangeBoundaryAllOf) ToMap() (map[string]interface{}, error) {
