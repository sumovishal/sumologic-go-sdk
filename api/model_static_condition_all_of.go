...
// checks if the StaticConditionAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StaticConditionAllOf{}
...
func (o StaticConditionAllOf) ToMap() (map[string]interface{}, error) {
