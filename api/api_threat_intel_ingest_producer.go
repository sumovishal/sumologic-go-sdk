...
// ThreatIntelIngestProducerAPIService ThreatIntelIngestProducerAPI service
type ThreatIntelIngestProducerAPIService service

type ApiRemoveIndicatorsRequest struct {
	ctx context.Context
	ApiService *ThreatIntelIngestProducerAPIService
...
*/
func (a *ThreatIntelIngestProducerAPIService) RemoveIndicators(ctx context.Context) ApiRemoveIndicatorsRequest {
	return ApiRemoveIndicatorsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ThreatIntelIngestProducerAPIService) RemoveIndicatorsExecute(r ApiRemoveIndicatorsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ThreatIntelIngestProducerAPIService.RemoveIndicators")
	if err != nil {
...
*/
func (a *ThreatIntelIngestProducerAPIService) UploadNormalizedIndicators(ctx context.Context) ApiUploadNormalizedIndicatorsRequest {
	return ApiUploadNormalizedIndicatorsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ThreatIntelIngestProducerAPIService) UploadNormalizedIndicatorsExecute(r ApiUploadNormalizedIndicatorsRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ThreatIntelIngestProducerAPIService.UploadNormalizedIndicators")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ThreatIntelIngestProducerAPIService) UploadStixIndicators(ctx context.Context) ApiUploadStixIndicatorsRequest {
	return ApiUploadStixIndicatorsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ThreatIntelIngestProducerAPIService) UploadStixIndicatorsExecute(r ApiUploadStixIndicatorsRequest) (*UploadStixIndicatorsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ThreatIntelIngestProducerAPIService.UploadStixIndicators")
	if err != nil {
