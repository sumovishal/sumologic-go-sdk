...
// checks if the DynamicRuleAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicRuleAllOf{}
...
func (o DynamicRuleAllOf) ToMap() (map[string]interface{}, error) {
