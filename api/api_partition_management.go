...
type ApiGetPartitionsQuotaRequest struct {
	ctx context.Context
	ApiService *PartitionManagementAPIService
}

func (r ApiGetPartitionsQuotaRequest) Execute() (*PartitionsQuotaUsage, *http.Response, error) {
	return r.ApiService.GetPartitionsQuotaExecute(r)
}

/*
GetPartitionsQuota Provides information about partitions quota.

Every customer can use a limited number of partitions. This endpoint allows learning about these limitations and remaining quota.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetPartitionsQuotaRequest
*/
func (a *PartitionManagementAPIService) GetPartitionsQuota(ctx context.Context) ApiGetPartitionsQuotaRequest {
	return ApiGetPartitionsQuotaRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PartitionsQuotaUsage
func (a *PartitionManagementAPIService) GetPartitionsQuotaExecute(r ApiGetPartitionsQuotaRequest) (*PartitionsQuotaUsage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *PartitionsQuotaUsage
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PartitionManagementAPIService.GetPartitionsQuota")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/partitions/quota"
...
func (a *PartitionManagementAPIService) ListPartitionsExecute(r ApiListPartitionsRequest) (*ListPartitionsResponse, *http.Response, error) {
	...
	if r.viewTypes != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "viewTypes", r.viewTypes, "form", "csv")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
