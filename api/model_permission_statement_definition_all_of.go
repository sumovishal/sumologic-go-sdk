...
// checks if the PermissionStatementDefinitionAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionStatementDefinitionAllOf{}
...
func (o PermissionStatementDefinitionAllOf) ToMap() (map[string]interface{}, error) {
