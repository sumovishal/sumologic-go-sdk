...
func (r ApiListScopesRequest) Execute() (*ScopesList, *http.Response, error) {
...
*/
func (a *AccessKeyManagementAPIService) ListScopes(ctx context.Context) ApiListScopesRequest {
	return ApiListScopesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ScopesList
func (a *AccessKeyManagementAPIService) ListScopesExecute(r ApiListScopesRequest) (*ScopesList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ScopesList
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccessKeyManagementAPIService.ListScopes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/accessKeys/scopes"
