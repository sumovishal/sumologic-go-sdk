...
// checks if the SlosLibraryFolderResponseAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SlosLibraryFolderResponseAllOf{}
...
func (o SlosLibraryFolderResponseAllOf) ToMap() (map[string]interface{}, error) {
