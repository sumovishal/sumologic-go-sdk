...
func (a *UserManagementAPIService) DeleteUserExecute(r ApiDeleteUserRequest) (*http.Response, error) {
	...
	if r.transferTo != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "transferTo", r.transferTo, "form", "")
	}
	if r.deleteContent != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "deleteContent", r.deleteContent, "form", "")
	}
	// to determine the Content-Type header
...
func (r ApiListUsersRequest) IncludeServiceAccounts(includeServiceAccounts bool) ApiListUsersRequest {
...
func (a *UserManagementAPIService) ListUsersExecute(r ApiListUsersRequest) (*ListUserModelsResponse, *http.Response, error) {
	...
	if r.includeServiceAccounts != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeServiceAccounts", r.includeServiceAccounts, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
