...
// checks if the AddOrReplaceTransformationAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddOrReplaceTransformationAllOf{}
...
func (o AddOrReplaceTransformationAllOf) ToMap() (map[string]interface{}, error) {
