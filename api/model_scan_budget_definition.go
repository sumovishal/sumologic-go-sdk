...
type ScanBudgetDefinition struct {
	...
	// Unit of the budget.
	Unit string `json:"unit" validate:"regexp=^(GB)$"`
	// Type of the budget.
	BudgetType string `json:"budgetType" validate:"regexp=^(ScanBudget)$"`
	Scope ScanBudgetScope `json:"scope"`
	// Window of the budget.
	Window string `json:"window" validate:"regexp=^(Query)$"`
	// Grouping of the budget.
	ApplicableOn string `json:"applicableOn" validate:"regexp=^(PerEntity)$"`
