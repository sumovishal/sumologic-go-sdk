...
// checks if the MonitorsLibraryMonitorResponseAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MonitorsLibraryMonitorResponseAllOf{}
...
func (o MonitorsLibraryMonitorResponseAllOf) ToMap() (map[string]interface{}, error) {
