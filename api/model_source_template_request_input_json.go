...
// checks if the SourceTemplateRequestInputJson type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceTemplateRequestInputJson{}

// SourceTemplateRequestInputJson inputJson of source template
type SourceTemplateRequestInputJson struct {
...
type _SourceTemplateRequestInputJson SourceTemplateRequestInputJson
...
func NewSourceTemplateRequestInputJson(name string, receivers map[string]interface{}) *SourceTemplateRequestInputJson {
	this := SourceTemplateRequestInputJson{}
	this.Name = name
...
func (o SourceTemplateRequestInputJson) MarshalJSON() ([]byte, error) {
...
func (o SourceTemplateRequestInputJson) ToMap() (map[string]interface{}, error) {
...
func (o *SourceTemplateRequestInputJson) UnmarshalJSON(data []byte) (err error) {
	...
	varSourceTemplateRequestInputJson := _SourceTemplateRequestInputJson{}

	err = json.Unmarshal(data, &varSourceTemplateRequestInputJson)

	if err != nil {
		return err
	}

	*o = SourceTemplateRequestInputJson(varSourceTemplateRequestInputJson)
...
type NullableSourceTemplateRequestInputJson struct {
	value *SourceTemplateRequestInputJson
	isSet bool
}

func (v NullableSourceTemplateRequestInputJson) Get() *SourceTemplateRequestInputJson {
	return v.value
}

func (v *NullableSourceTemplateRequestInputJson) Set(val *SourceTemplateRequestInputJson) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceTemplateRequestInputJson) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceTemplateRequestInputJson) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceTemplateRequestInputJson(val *SourceTemplateRequestInputJson) *NullableSourceTemplateRequestInputJson {
	return &NullableSourceTemplateRequestInputJson{value: val, isSet: true}
}

func (v NullableSourceTemplateRequestInputJson) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceTemplateRequestInputJson) UnmarshalJSON(src []byte) error {
	v.isSet = true
