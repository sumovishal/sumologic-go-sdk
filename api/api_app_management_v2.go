...
type ApiGetAppDetailsRequest struct {
	ctx context.Context
	ApiService *AppManagementV2APIService
	uuid string
	version *string
...
func (r ApiGetAppDetailsRequest) Version(version string) ApiGetAppDetailsRequest {
	r.version = &version
	return r
}

func (r ApiGetAppDetailsRequest) Execute() (*GetAppDetailsResponse, *http.Response, error) {
	return r.ApiService.GetAppDetailsExecute(r)
}
...
Get details about an app with the given UUID and version. The details include:
 ...
 @return ApiGetAppDetailsRequest
*/
func (a *AppManagementV2APIService) GetAppDetails(ctx context.Context, uuid string) ApiGetAppDetailsRequest {
	return ApiGetAppDetailsRequest{
		ApiService: a,
		ctx: ctx,
		uuid: uuid,
...
func (a *AppManagementV2APIService) GetAppDetailsExecute(r ApiGetAppDetailsRequest) (*GetAppDetailsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetAppDetailsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AppManagementV2APIService.GetAppDetails")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/apps/{uuid}/details"
	localVarPath = strings.Replace(localVarPath, "{"+"uuid"+"}", url.PathEscape(parameterValueToString(r.uuid, "uuid")), -1)
...
type ApiListAppsV2Request struct {
	ctx context.Context
	ApiService *AppManagementV2APIService
	name *string
	author *string
...
// Name of the app.
func (r ApiListAppsV2Request) Name(name string) ApiListAppsV2Request {
	r.name = &name
	return r
}

// Author of the app.
func (r ApiListAppsV2Request) Author(author string) ApiListAppsV2Request {
	r.author = &author
	return r
}

func (r ApiListAppsV2Request) Execute() (*ListAppsV2Response, *http.Response, error) {
	return r.ApiService.ListAppsV2Execute(r)
}
...
List all apps from the App Catalog.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiListAppsV2Request
*/
func (a *AppManagementV2APIService) ListAppsV2(ctx context.Context) ApiListAppsV2Request {
	return ApiListAppsV2Request{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AppManagementV2APIService) ListAppsV2Execute(r ApiListAppsV2Request) (*ListAppsV2Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListAppsV2Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AppManagementV2APIService.ListAppsV2")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/apps"
