...
type ApiDataSourcePropertiesUpdateRequest struct {
	ctx context.Context
...
// Source properties
func (r ApiDataSourcePropertiesUpdateRequest) DataSourceProperties(dataSourceProperties DataSourceProperties) ApiDataSourcePropertiesUpdateRequest {
	r.dataSourceProperties = &dataSourceProperties
	return r
}

func (r ApiDataSourcePropertiesUpdateRequest) Execute() (*http.Response, error) {
	return r.ApiService.DataSourcePropertiesUpdateExecute(r)
}
...
Updates source properties
 ...
 @return ApiDataSourcePropertiesUpdateRequest
*/
func (a *ThreatIntelIngestAPIService) DataSourcePropertiesUpdate(ctx context.Context, dataSourceName string) ApiDataSourcePropertiesUpdateRequest {
	return ApiDataSourcePropertiesUpdateRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ThreatIntelIngestAPIService) DataSourcePropertiesUpdateExecute(r ApiDataSourcePropertiesUpdateRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ThreatIntelIngestAPIService.DataSourcePropertiesUpdate")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/threatIntel/datastore/dataSource/{dataSourceName}"
	localVarPath = strings.Replace(localVarPath, "{"+"dataSourceName"+"}", url.PathEscape(parameterValueToString(r.dataSourceName, "dataSourceName")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.dataSourceProperties == nil {
		return nil, reportError("dataSourceProperties is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.dataSourceProperties
