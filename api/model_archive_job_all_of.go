...
// checks if the ArchiveJobAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ArchiveJobAllOf{}
...
func (o ArchiveJobAllOf) ToMap() (map[string]interface{}, error) {
