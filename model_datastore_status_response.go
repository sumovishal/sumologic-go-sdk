...
// GetIndicatorLimit returns the IndicatorLimit field value
func (o *DatastoreStatusResponse) GetIndicatorLimit() int64 {
	...
	return o.IndicatorLimit
}

// GetIndicatorLimitOk returns a tuple with the IndicatorLimit field value
// and a boolean to check if the value has been set.
func (o *DatastoreStatusResponse) GetIndicatorLimitOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IndicatorLimit, true
}

// SetIndicatorLimit sets field value
...
func (o *DatastoreStatusResponse) UnmarshalJSON(data []byte) (err error) {
