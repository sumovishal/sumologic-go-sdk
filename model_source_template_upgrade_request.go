...
// checks if the SourceTemplateUpgradeRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceTemplateUpgradeRequest{}
...
func NewSourceTemplateUpgradeRequest(schemaRef UpgradeSchemaRef, inputJson SourceTemplateUpgradeRequestInputJson) *SourceTemplateUpgradeRequest {
	this := SourceTemplateUpgradeRequest{}
...
// GetSchemaRef returns the SchemaRef field value
func (o *SourceTemplateUpgradeRequest) GetSchemaRef() UpgradeSchemaRef {
	if o == nil {
		var ret UpgradeSchemaRef
		return ret
	}
...
// GetSchemaRefOk returns a tuple with the SchemaRef field value
...
// GetInputJsonOk returns a tuple with the InputJson field value
// and a boolean to check if the value has been set.
...
func (o SourceTemplateUpgradeRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SourceTemplateUpgradeRequest) UnmarshalJSON(data []byte) (err error) {
...
type NullableSourceTemplateUpgradeRequest struct {
	value *SourceTemplateUpgradeRequest
	isSet bool
}

func (v NullableSourceTemplateUpgradeRequest) Get() *SourceTemplateUpgradeRequest {
	return v.value
}

func (v *NullableSourceTemplateUpgradeRequest) Set(val *SourceTemplateUpgradeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceTemplateUpgradeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceTemplateUpgradeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceTemplateUpgradeRequest(val *SourceTemplateUpgradeRequest) *NullableSourceTemplateUpgradeRequest {
	return &NullableSourceTemplateUpgradeRequest{value: val, isSet: true}
}

func (v NullableSourceTemplateUpgradeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceTemplateUpgradeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
