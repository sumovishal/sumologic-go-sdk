...
type CreateJobRequest struct {
	...
	To string `json:"to"`
	// The time zone of the from and to time.
...
func NewCreateJobRequest(query string, from string, to string) *CreateJobRequest {
	...
	var byReceiptTime string = "false"
...
// SetByReceiptTime gets a reference to the given string and assigns it to the ByReceiptTime field.
