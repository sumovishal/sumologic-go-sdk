...
// checks if the CollectorCompatibility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectorCompatibility{}

// CollectorCompatibility struct for CollectorCompatibility
type CollectorCompatibility struct {
...
// SetCollectorVersionRange gets a reference to the given CollectorVersionRange and assigns it to the CollectorVersionRange field.
func (o *CollectorCompatibility) SetCollectorVersionRange(v CollectorVersionRange) {
	o.CollectorVersionRange = &v
}

func (o CollectorCompatibility) MarshalJSON() ([]byte, error) {
...
func (o CollectorCompatibility) ToMap() (map[string]interface{}, error) {
...
type NullableCollectorCompatibility struct {
	value *CollectorCompatibility
	isSet bool
}

func (v NullableCollectorCompatibility) Get() *CollectorCompatibility {
	return v.value
}

func (v *NullableCollectorCompatibility) Set(val *CollectorCompatibility) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectorCompatibility) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectorCompatibility) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectorCompatibility(val *CollectorCompatibility) *NullableCollectorCompatibility {
	return &NullableCollectorCompatibility{value: val, isSet: true}
}

func (v NullableCollectorCompatibility) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectorCompatibility) UnmarshalJSON(src []byte) error {
	v.isSet = true
