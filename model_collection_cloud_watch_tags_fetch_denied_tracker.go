...
func (o *CollectionCloudWatchTagsFetchDeniedTracker) UnmarshalJSON(data []byte) (err error) {
	...
	type CollectionCloudWatchTagsFetchDeniedTrackerWithoutEmbeddedStruct struct {
		// Event type.
		EventType *string `json:"eventType,omitempty"`
	}

	varCollectionCloudWatchTagsFetchDeniedTrackerWithoutEmbeddedStruct := CollectionCloudWatchTagsFetchDeniedTrackerWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varCollectionCloudWatchTagsFetchDeniedTrackerWithoutEmbeddedStruct)
	if err == nil {
		varCollectionCloudWatchTagsFetchDeniedTracker := _CollectionCloudWatchTagsFetchDeniedTracker{}
		varCollectionCloudWatchTagsFetchDeniedTracker.EventType = varCollectionCloudWatchTagsFetchDeniedTrackerWithoutEmbeddedStruct.EventType
	...
	err = json.Unmarshal(data, &varCollectionCloudWatchTagsFetchDeniedTracker)
	if err == nil {
		o.TrackerIdentity = varCollectionCloudWatchTagsFetchDeniedTracker.TrackerIdentity
	} else {
		return err
	}
