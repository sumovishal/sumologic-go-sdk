...
// checks if the DataSourceProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataSourceProperties{}

// DataSourceProperties struct for DataSourceProperties
...
func (o DataSourceProperties) MarshalJSON() ([]byte, error) {
...
func (o DataSourceProperties) ToMap() (map[string]interface{}, error) {
...
func (v NullableDataSourceProperties) Get() *DataSourceProperties {
	return v.value
}

func (v *NullableDataSourceProperties) Set(val *DataSourceProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableDataSourceProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableDataSourceProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataSourceProperties(val *DataSourceProperties) *NullableDataSourceProperties {
	return &NullableDataSourceProperties{value: val, isSet: true}
}

func (v NullableDataSourceProperties) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataSourceProperties) UnmarshalJSON(src []byte) error {
	v.isSet = true
