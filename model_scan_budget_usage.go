...
// checks if the ScanBudgetUsage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScanBudgetUsage{}

// ScanBudgetUsage struct for ScanBudgetUsage
type ScanBudgetUsage struct {
	// Budget id.
	BudgetId string `json:"budgetId"`
	// Budget usage (in bytes).
...
func (o ScanBudgetUsage) MarshalJSON() ([]byte, error) {
...
func (o ScanBudgetUsage) ToMap() (map[string]interface{}, error) {
...
func (o *ScanBudgetUsage) UnmarshalJSON(data []byte) (err error) {
...
type NullableScanBudgetUsage struct {
	value *ScanBudgetUsage
	isSet bool
}

func (v NullableScanBudgetUsage) Get() *ScanBudgetUsage {
	return v.value
}

func (v *NullableScanBudgetUsage) Set(val *ScanBudgetUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableScanBudgetUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableScanBudgetUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScanBudgetUsage(val *ScanBudgetUsage) *NullableScanBudgetUsage {
	return &NullableScanBudgetUsage{value: val, isSet: true}
}

func (v NullableScanBudgetUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScanBudgetUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
