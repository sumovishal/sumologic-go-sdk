...
// checks if the SCIMPatchUserDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SCIMPatchUserDefinition{}

// SCIMPatchUserDefinition struct for SCIMPatchUserDefinition
type SCIMPatchUserDefinition struct {
	// Defines the SCIM schemas for the patch operation
...
func (o *SCIMPatchUserDefinition) GetOperations() []SCIMPatchUserDefinitionOperationsInner {
	if o == nil {
		var ret []SCIMPatchUserDefinitionOperationsInner
		return ret
	}
...
func (o SCIMPatchUserDefinition) MarshalJSON() ([]byte, error) {
...
func (o SCIMPatchUserDefinition) ToMap() (map[string]interface{}, error) {
...
func (o *SCIMPatchUserDefinition) UnmarshalJSON(data []byte) (err error) {
...
type NullableSCIMPatchUserDefinition struct {
	value *SCIMPatchUserDefinition
	isSet bool
}

func (v NullableSCIMPatchUserDefinition) Get() *SCIMPatchUserDefinition {
	return v.value
}

func (v *NullableSCIMPatchUserDefinition) Set(val *SCIMPatchUserDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableSCIMPatchUserDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableSCIMPatchUserDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSCIMPatchUserDefinition(val *SCIMPatchUserDefinition) *NullableSCIMPatchUserDefinition {
	return &NullableSCIMPatchUserDefinition{value: val, isSet: true}
}

func (v NullableSCIMPatchUserDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSCIMPatchUserDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
