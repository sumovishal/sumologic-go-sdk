...
// checks if the SourceTemplateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceTemplateRequest{}

// SourceTemplateRequest request body for creating source template.
type SourceTemplateRequest struct {
...
func (o *SourceTemplateRequest) GetInputJson() SourceTemplateRequestInputJson {
	if o == nil {
		var ret SourceTemplateRequestInputJson
		return ret
	}
...
func (o SourceTemplateRequest) MarshalJSON() ([]byte, error) {
...
func (o SourceTemplateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SourceTemplateRequest) UnmarshalJSON(data []byte) (err error) {
...
type NullableSourceTemplateRequest struct {
	value *SourceTemplateRequest
	isSet bool
}

func (v NullableSourceTemplateRequest) Get() *SourceTemplateRequest {
	return v.value
}

func (v *NullableSourceTemplateRequest) Set(val *SourceTemplateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceTemplateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceTemplateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceTemplateRequest(val *SourceTemplateRequest) *NullableSourceTemplateRequest {
	return &NullableSourceTemplateRequest{value: val, isSet: true}
}

func (v NullableSourceTemplateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceTemplateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
