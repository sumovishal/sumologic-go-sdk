...
// checks if the CreateJobResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateJobResponse{}

// CreateJobResponse struct for CreateJobResponse
...
func (o CreateJobResponse) MarshalJSON() ([]byte, error) {
...
func (o CreateJobResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCreateJobResponse struct {
	value *CreateJobResponse
	isSet bool
}

func (v NullableCreateJobResponse) Get() *CreateJobResponse {
	return v.value
}

func (v *NullableCreateJobResponse) Set(val *CreateJobResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateJobResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateJobResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateJobResponse(val *CreateJobResponse) *NullableCreateJobResponse {
	return &NullableCreateJobResponse{value: val, isSet: true}
}

func (v NullableCreateJobResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateJobResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
