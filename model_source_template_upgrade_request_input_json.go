...
// checks if the SourceTemplateUpgradeRequestInputJson type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceTemplateUpgradeRequestInputJson{}

// SourceTemplateUpgradeRequestInputJson inputJson of source template
type SourceTemplateUpgradeRequestInputJson struct {
...
type _SourceTemplateUpgradeRequestInputJson SourceTemplateUpgradeRequestInputJson
...
func NewSourceTemplateUpgradeRequestInputJson(name string, receivers map[string]interface{}) *SourceTemplateUpgradeRequestInputJson {
	this := SourceTemplateUpgradeRequestInputJson{}
	this.Name = name
...
func (o SourceTemplateUpgradeRequestInputJson) MarshalJSON() ([]byte, error) {
...
func (o SourceTemplateUpgradeRequestInputJson) ToMap() (map[string]interface{}, error) {
...
func (o *SourceTemplateUpgradeRequestInputJson) UnmarshalJSON(data []byte) (err error) {
	...
	varSourceTemplateUpgradeRequestInputJson := _SourceTemplateUpgradeRequestInputJson{}

	err = json.Unmarshal(data, &varSourceTemplateUpgradeRequestInputJson)

	if err != nil {
		return err
	}

	*o = SourceTemplateUpgradeRequestInputJson(varSourceTemplateUpgradeRequestInputJson)
...
type NullableSourceTemplateUpgradeRequestInputJson struct {
	value *SourceTemplateUpgradeRequestInputJson
	isSet bool
}

func (v NullableSourceTemplateUpgradeRequestInputJson) Get() *SourceTemplateUpgradeRequestInputJson {
	return v.value
}

func (v *NullableSourceTemplateUpgradeRequestInputJson) Set(val *SourceTemplateUpgradeRequestInputJson) {
	v.value = val
	v.isSet = true
}

func (v NullableSourceTemplateUpgradeRequestInputJson) IsSet() bool {
	return v.isSet
}

func (v *NullableSourceTemplateUpgradeRequestInputJson) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSourceTemplateUpgradeRequestInputJson(val *SourceTemplateUpgradeRequestInputJson) *NullableSourceTemplateUpgradeRequestInputJson {
	return &NullableSourceTemplateUpgradeRequestInputJson{value: val, isSet: true}
}

func (v NullableSourceTemplateUpgradeRequestInputJson) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSourceTemplateUpgradeRequestInputJson) UnmarshalJSON(src []byte) error {
	v.isSet = true
