...
// checks if the GetSearchJobStatusResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSearchJobStatusResponse{}

// GetSearchJobStatusResponse struct for GetSearchJobStatusResponse
type GetSearchJobStatusResponse struct {
	// Search job state.
	...
	// Histogram buckets for the query.
...
func NewGetSearchJobStatusResponse() *GetSearchJobStatusResponse {
	this := GetSearchJobStatusResponse{}
	return &this
}
...
func (o *GetSearchJobStatusResponse) GetHistogramBuckets() []HistogramBucket {
	if o == nil || IsNil(o.HistogramBuckets) {
...
func (o *GetSearchJobStatusResponse) GetPendingErrors() []string {
	if o == nil || IsNil(o.PendingErrors) {
		var ret []string
		return ret
	}
...
// SetPendingErrors gets a reference to the given []string and assigns it to the PendingErrors field.
...
func (o *GetSearchJobStatusResponse) GetPendingWarnings() []string {
	if o == nil || IsNil(o.PendingWarnings) {
		var ret []string
		return ret
	}
...
// SetPendingWarnings gets a reference to the given []string and assigns it to the PendingWarnings field.
func (o *GetSearchJobStatusResponse) SetPendingWarnings(v []string) {
	o.PendingWarnings = v
}

func (o GetSearchJobStatusResponse) MarshalJSON() ([]byte, error) {
...
func (o GetSearchJobStatusResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.HistogramBuckets) {
		toSerialize["histogramBuckets"] = o.HistogramBuckets
	}
	if !IsNil(o.PendingErrors) {
...
type NullableGetSearchJobStatusResponse struct {
	value *GetSearchJobStatusResponse
	isSet bool
}

func (v NullableGetSearchJobStatusResponse) Get() *GetSearchJobStatusResponse {
	return v.value
}

func (v *NullableGetSearchJobStatusResponse) Set(val *GetSearchJobStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSearchJobStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSearchJobStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSearchJobStatusResponse(val *GetSearchJobStatusResponse) *NullableGetSearchJobStatusResponse {
	return &NullableGetSearchJobStatusResponse{value: val, isSet: true}
}

func (v NullableGetSearchJobStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSearchJobStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
