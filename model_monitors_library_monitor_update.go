...
func (o *MonitorsLibraryMonitorUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	type MonitorsLibraryMonitorUpdateWithoutEmbeddedStruct struct {
		// The type of monitor. Valid values:   1. `Logs`: A logs query monitor.   2. `Metrics`: A metrics query monitor.   3. `Slo`: A SLO based monitor. Currently SLO based monitor is available in closed beta (Notify your Sumo Logic representative in order to get the early access).
		MonitorType string `json:"monitorType" validate:"regexp=^(Logs|Metrics|Slo)$"`
		// The delay duration for evaluating the monitor (relative to current time). The timerange of monitor will be shifted in the past by this delay time.
		EvaluationDelay *string `json:"evaluationDelay,omitempty"`
	...
	varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct := MonitorsLibraryMonitorUpdateWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct)
	if err == nil {
		varMonitorsLibraryMonitorUpdate := _MonitorsLibraryMonitorUpdate{}
		varMonitorsLibraryMonitorUpdate.MonitorType = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.MonitorType
		varMonitorsLibraryMonitorUpdate.EvaluationDelay = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.EvaluationDelay
		varMonitorsLibraryMonitorUpdate.AlertName = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.AlertName
		varMonitorsLibraryMonitorUpdate.RunAs = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.RunAs
		varMonitorsLibraryMonitorUpdate.NotificationGroupFields = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.NotificationGroupFields
		varMonitorsLibraryMonitorUpdate.Queries = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.Queries
		varMonitorsLibraryMonitorUpdate.Triggers = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.Triggers
		varMonitorsLibraryMonitorUpdate.TimeZone = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.TimeZone
		varMonitorsLibraryMonitorUpdate.Notifications = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.Notifications
		varMonitorsLibraryMonitorUpdate.IsDisabled = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.IsDisabled
		varMonitorsLibraryMonitorUpdate.GroupNotifications = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.GroupNotifications
		varMonitorsLibraryMonitorUpdate.Playbook = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.Playbook
		varMonitorsLibraryMonitorUpdate.SloId = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.SloId
		varMonitorsLibraryMonitorUpdate.AutomatedPlaybookIds = varMonitorsLibraryMonitorUpdateWithoutEmbeddedStruct.AutomatedPlaybookIds
	...
	err = json.Unmarshal(data, &varMonitorsLibraryMonitorUpdate)
	if err == nil {
		o.MonitorsLibraryBaseUpdate = varMonitorsLibraryMonitorUpdate.MonitorsLibraryBaseUpdate
	} else {
		return err
	}
