...
// checks if the CollectorVersionRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CollectorVersionRange{}

// CollectorVersionRange struct for CollectorVersionRange
type CollectorVersionRange struct {
	// Minimum compatible version of otCollector.
...
func (o *CollectorVersionRange) GetMaxVersion() string {
	if o == nil || IsNil(o.MaxVersion.Get()) {
		var ret string
		return ret
	}
	return *o.MaxVersion.Get()
}
...
// SetMaxVersion gets a reference to the given NullableString and assigns it to the MaxVersion field.
func (o *CollectorVersionRange) SetMaxVersion(v string) {
	o.MaxVersion.Set(&v)
}
// SetMaxVersionNil sets the value for MaxVersion to be an explicit nil
func (o *CollectorVersionRange) SetMaxVersionNil() {
	o.MaxVersion.Set(nil)
}
...
func (o CollectorVersionRange) MarshalJSON() ([]byte, error) {
...
func (o CollectorVersionRange) ToMap() (map[string]interface{}, error) {
...
type NullableCollectorVersionRange struct {
	value *CollectorVersionRange
	isSet bool
}

func (v NullableCollectorVersionRange) Get() *CollectorVersionRange {
	return v.value
}

func (v *NullableCollectorVersionRange) Set(val *CollectorVersionRange) {
	v.value = val
	v.isSet = true
}

func (v NullableCollectorVersionRange) IsSet() bool {
	return v.isSet
}

func (v *NullableCollectorVersionRange) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCollectorVersionRange(val *CollectorVersionRange) *NullableCollectorVersionRange {
	return &NullableCollectorVersionRange{value: val, isSet: true}
}

func (v NullableCollectorVersionRange) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCollectorVersionRange) UnmarshalJSON(src []byte) error {
	v.isSet = true
