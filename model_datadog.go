...
func (o *Datadog) UnmarshalJSON(data []byte) (err error) {
	...
	type DatadogWithoutEmbeddedStruct struct {
		// The identifier of the connection.
		ConnectionId string `json:"connectionId"`
		// The override of the default JSON payload of the connection. Should be in JSON format.
		PayloadOverride *string `json:"payloadOverride,omitempty"`
	...
	varDatadogWithoutEmbeddedStruct := DatadogWithoutEmbeddedStruct{}

	err = json.Unmarshal(data, &varDatadogWithoutEmbeddedStruct)
	if err == nil {
		varDatadog := _Datadog{}
		varDatadog.ConnectionId = varDatadogWithoutEmbeddedStruct.ConnectionId
		varDatadog.PayloadOverride = varDatadogWithoutEmbeddedStruct.PayloadOverride
	...
	err = json.Unmarshal(data, &varDatadog)
	if err == nil {
		o.Action = varDatadog.Action
	} else {
		return err
	}
