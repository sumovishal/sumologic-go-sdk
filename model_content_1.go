...
type Content1 struct {
	// Identifier of Content or Configuration
	Id string `json:"id"`
	// Type Of Content.
...
func (o Content1) MarshalJSON() ([]byte, error) {
...
func (o Content1) ToMap() (map[string]interface{}, error) {
...
func (o *Content1) UnmarshalJSON(data []byte) (err error) {
