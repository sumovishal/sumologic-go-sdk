...
// checks if the SchemaBaseIdentityWithMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchemaBaseIdentityWithMetadata{}

// SchemaBaseIdentityWithMetadata struct for SchemaBaseIdentityWithMetadata
type SchemaBaseIdentityWithMetadata struct {
...
func NewSchemaBaseIdentityWithMetadata(type_ string, version string, schema map[string]interface{}, family string, id string) *SchemaBaseIdentityWithMetadata {
	this := SchemaBaseIdentityWithMetadata{}
	this.Type = type_
...
func (o SchemaBaseIdentityWithMetadata) MarshalJSON() ([]byte, error) {
...
func (o SchemaBaseIdentityWithMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *SchemaBaseIdentityWithMetadata) UnmarshalJSON(data []byte) (err error) {
...
type NullableSchemaBaseIdentityWithMetadata struct {
	value *SchemaBaseIdentityWithMetadata
	isSet bool
}

func (v NullableSchemaBaseIdentityWithMetadata) Get() *SchemaBaseIdentityWithMetadata {
	return v.value
}

func (v *NullableSchemaBaseIdentityWithMetadata) Set(val *SchemaBaseIdentityWithMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSchemaBaseIdentityWithMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSchemaBaseIdentityWithMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchemaBaseIdentityWithMetadata(val *SchemaBaseIdentityWithMetadata) *NullableSchemaBaseIdentityWithMetadata {
	return &NullableSchemaBaseIdentityWithMetadata{value: val, isSet: true}
}

func (v NullableSchemaBaseIdentityWithMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchemaBaseIdentityWithMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
