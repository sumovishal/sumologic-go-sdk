...
type ApiGetScheduledViewsQuotaRequest struct {
	ctx context.Context
	ApiService *ScheduledViewManagementAPIService
}

func (r ApiGetScheduledViewsQuotaRequest) Execute() (*ScheduledViewsQuotaUsage, *http.Response, error) {
	return r.ApiService.GetScheduledViewsQuotaExecute(r)
}
...
Every customer can use a limited number of scheduled views. This endpoint allows learning about these limitations and remaining quota.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetScheduledViewsQuotaRequest
*/
func (a *ScheduledViewManagementAPIService) GetScheduledViewsQuota(ctx context.Context) ApiGetScheduledViewsQuotaRequest {
	return ApiGetScheduledViewsQuotaRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ScheduledViewsQuotaUsage
func (a *ScheduledViewManagementAPIService) GetScheduledViewsQuotaExecute(r ApiGetScheduledViewsQuotaRequest) (*ScheduledViewsQuotaUsage, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ScheduledViewsQuotaUsage
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ScheduledViewManagementAPIService.GetScheduledViewsQuota")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/scheduledViews/quota"
