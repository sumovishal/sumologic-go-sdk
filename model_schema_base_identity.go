...
// checks if the SchemaBaseIdentity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchemaBaseIdentity{}

// SchemaBaseIdentity struct for SchemaBaseIdentity
type SchemaBaseIdentity struct {
...
func (o SchemaBaseIdentity) MarshalJSON() ([]byte, error) {
...
func (o SchemaBaseIdentity) ToMap() (map[string]interface{}, error) {
...
func (o *SchemaBaseIdentity) UnmarshalJSON(data []byte) (err error) {
...
type NullableSchemaBaseIdentity struct {
	value *SchemaBaseIdentity
	isSet bool
}

func (v NullableSchemaBaseIdentity) Get() *SchemaBaseIdentity {
	return v.value
}

func (v *NullableSchemaBaseIdentity) Set(val *SchemaBaseIdentity) {
	v.value = val
	v.isSet = true
}

func (v NullableSchemaBaseIdentity) IsSet() bool {
	return v.isSet
}

func (v *NullableSchemaBaseIdentity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchemaBaseIdentity(val *SchemaBaseIdentity) *NullableSchemaBaseIdentity {
	return &NullableSchemaBaseIdentity{value: val, isSet: true}
}

func (v NullableSchemaBaseIdentity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchemaBaseIdentity) UnmarshalJSON(src []byte) error {
	v.isSet = true
