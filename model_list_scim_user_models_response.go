...
// checks if the ListSCIMUserModelsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSCIMUserModelsResponse{}

// ListSCIMUserModelsResponse struct for ListSCIMUserModelsResponse
type ListSCIMUserModelsResponse struct {
...
func NewListSCIMUserModelsResponse() *ListSCIMUserModelsResponse {
	this := ListSCIMUserModelsResponse{}
	return &this
}
...
// SetResources gets a reference to the given []SCIMUserModel and assigns it to the Resources field.
func (o *ListSCIMUserModelsResponse) SetResources(v []SCIMUserModel) {
	o.Resources = v
}

func (o ListSCIMUserModelsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListSCIMUserModelsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableListSCIMUserModelsResponse struct {
	value *ListSCIMUserModelsResponse
	isSet bool
}

func (v NullableListSCIMUserModelsResponse) Get() *ListSCIMUserModelsResponse {
	return v.value
}

func (v *NullableListSCIMUserModelsResponse) Set(val *ListSCIMUserModelsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListSCIMUserModelsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListSCIMUserModelsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSCIMUserModelsResponse(val *ListSCIMUserModelsResponse) *NullableListSCIMUserModelsResponse {
	return &NullableListSCIMUserModelsResponse{value: val, isSet: true}
}

func (v NullableListSCIMUserModelsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSCIMUserModelsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
